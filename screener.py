...
class NaverStockScreener:
    ...
    SECTOR_PALETTE = {
        "화장품/뷰티": {"emoji": "💄", "bg": "rgba(244, 114, 182, 0.18)", "color": "#f472b6"},
        "항공/여행/운송": {"emoji": "✈️", "bg": "rgba(56, 189, 248, 0.18)", "color": "#38bdf8"},
        "조선/해양/방산": {"emoji": "🚢", "bg": "rgba(129, 140, 248, 0.18)", "color": "#818cf8"},
        "반도체/IT": {"emoji": "💻", "bg": "rgba(96, 165, 250, 0.18)", "color": "#60a5fa"},
        "바이오/제약": {"emoji": "🧬", "bg": "rgba(52, 211, 153, 0.18)", "color": "#34d399"},
        "로봇/AI/자동화": {"emoji": "🤖", "bg": "rgba(192, 132, 252, 0.18)", "color": "#c084fc"},
        "원전/에너지/신재생": {"emoji": "⚡", "bg": "rgba(250, 204, 21, 0.18)", "color": "#facc15"},
        "자동차/부품/전장": {"emoji": "🚗", "bg": "rgba(148, 163, 184, 0.18)", "color": "#cbd5e1"},
        "2차전지/배터리": {"emoji": "🔋", "bg": "rgba(45, 212, 191, 0.18)", "color": "#2dd4bf"},
        "디스플레이/전자": {"emoji": "🖥️", "bg": "rgba(167, 139, 250, 0.18)", "color": "#a78bfa"},
        "화학/소재/정밀": {"emoji": "🧪", "bg": "rgba(74, 222, 128, 0.18)", "color": "#4ade80"},
        "통신/인프라/지주": {"emoji": "📡", "bg": "rgba(148, 163, 184, 0.18)", "color": "#94a3b8"},
        "금융/증권/보험": {"emoji": "🏦", "bg": "rgba(251, 146, 60, 0.18)", "color": "#fb923c"},
        "철강/금속/기계": {"emoji": "⚙️", "bg": "rgba(156, 163, 175, 0.18)", "color": "#d1d5db"},
        "기타주도주": {"emoji": "🔥", "bg": "rgba(251, 113, 133, 0.18)", "color": "#fb7185"}
    }
    ...
    def fetch_naver_industry(code: str) -> str:
        ...
        try:
            ...
            if trade_comp:
                ...
                clean_txt = re.sub(r'[^가-힣a-zA-Z0-9\s/]', '', raw_txt).strip()
                if len(clean_txt) >= 2:
                    return clean_txt
        except Exception:
            pass
    ...
    def classify_sector(cls, code: str, name: str) -> dict:
        ...
        rules = [
            ...
            (["항공", "해운", "육상", "물류", "여행", "호텔", "운송", "리조트", "관광"], "항공/여행/운송"),
            (["조선", "해양", "방위", "우주", "항공우주", "방산"], "조선/해양/방산"),
            (["반도체", "IT", "소프트웨어", "인터넷", "전자장비"], "반도체/IT"),
            (["제약", "바이오", "생물", "헬스케어", "의료", "신약"], "바이오/제약"),
            (["로봇", "자동화", "인공지능", "AI", "스마트팩토리"], "로봇/AI/자동화"),
            (["원자력", "전력", "에너지", "풍력", "태양광", "신재생", "SMR"], "원전/에너지/신재생"),
