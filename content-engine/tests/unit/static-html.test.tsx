...
describe("renderStatic", () => {
  ...
  it("CardFrame 렌더", () => {
    const html = renderStatic(<CardFrame card={{ id: "c1", type: "calculation", title: "필요 투자금", subtitle: "", body: "", label: "연간", value: "600만 원", items: [], rows: [], factRefs: [] }} index={0} total={5} template="number-focus" colors={{ primary: "#0F766E", secondary: "#F0FDFA", accent: "#F59E0B" }} brandName="브랜드" size={{ width: 1080, height: 1350 }} />);
